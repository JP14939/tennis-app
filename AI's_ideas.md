...
Copied out of `docs/future-ideas.md` (written by the overnight "Brainstorm /
future plans" scheduled routine, 2026-08-23) for quick reference. That file
is the authoritative, append-only running log (new dated sections get added
there over time by the same routine) — this is just a standalone copy of the
most recent pass for convenience.
