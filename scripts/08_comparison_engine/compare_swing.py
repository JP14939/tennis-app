...
def find_peak_wrist_frame(frames, fps):
    ...
    for i, f in enumerate(frames):
        ...
        vel = 0
        # Same visibility gate as detect_swings.py's compute_wrist_velocity()
        # (the pro-database side of this exact computation) -- an unfiltered
        # low-confidence wrist position can produce a spuriously large
        # frame-to-frame displacement and get mistaken for contact.
