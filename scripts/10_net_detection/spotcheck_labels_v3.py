"""Visual spot-check for v3 labels, same pattern as spotcheck_labels_v2.py."""
import json
import os
import random
...
OUT_DIR = r'C:\Users\jackp\tennis_app\data\10_net_detection\label_spotcheck_v3'
...
if __name__ == '__main__':
    ...
    random.seed(7)
    sample = random.sample(usable, min(12, len(usable)))
