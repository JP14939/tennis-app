"""Visualize YOLO-pose net keypoint predictions on validation images (v3 model, 21 val images)."""
import glob
import os
...
VAL_IMAGES_DIR = r'C:\Users\jackp\tennis_app\data\10_net_detection\yolo_pose_dataset_v3\images\val'
OUT_DIR = r'C:\Users\jackp\tennis_app\data\10_net_detection\yolo_pose_validation_viz_v3'
